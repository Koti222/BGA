...
//////////// 
    ...
    /*
        ...
        (note: each method below must match an input method in heartsqsg.action.php)
    */
    ...
    function stEndHand() 
	{
		...
		foreach($player_to_points as $player_id => $points)
		{
			if($points != 0)
			{
				...
				self::notifyAllPlayers("points",clienttranslate('${player_name} gets ${nbr} hearts and loose ${nbr} points'), array (
																'player_id' => $player_id,
